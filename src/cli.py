...
@cli.command()
@click.option('--username', prompt='TickTick Username/Email', help='Your TickTick username or email')
@click.option('--password', prompt='TickTick Password', hide_input=True, help='Your TickTick password')
